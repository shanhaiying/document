...
%标题
\begin{document}
\title{\fontspec{Arial Black} \Large HJD Type Crane PLC transformation in control circuit \\
...
%文档
%摘要
\section*{\fontspec{Arial Black} \Large Abstract}
...
\end{flushright}
%大纲
\section*{\fontspec{Arial Black} \Large Outline}
...
%参考文献
\section*{\fontspec{Arial Black} \Large References}
\hangafter=1
...
%致谢
\section*{\fontspec{Arial Black} \Large Acknowledgments}
